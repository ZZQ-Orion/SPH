            ...
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" :class="{ active: attr.isChecked == 1 }"
                  v-for="attr in spuSaleAttr.spuSaleAttrValueList" :key="attr.id" @click="changeActive(spuSaleAttr.spuSaleAttrValueList,attr)">{{ attr.saleAttrValueName }}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="skuNum" @change="changSkuNum($event)">
...
export default {
  ...
  methods: {
    changeActive(spuSaleAttrValueList,attr){
    ...
    //   let result = this.$store.dispatch('addShopCar',{skuId,skuNum})
    //   console.log(result,'接收结果');
    // }

    async addShopCar(skuId,skuNum){
      try {
        // 成功
        await this.$store.dispatch('addShopCar',{skuId,skuNum})
      ...
      // let result = await this.$store.dispatch('addShopCar',{skuId,skuNum})
      // console.log(result);
    }
